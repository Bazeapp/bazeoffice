export const selectors = {
  ...
  sidebarMenuUser: '[data-testid="sidebar-menu-user"]',
  sidebarMenuLogout: '[data-testid="sidebar-menu-logout"]',
  sidebarLink: (id: string) => `[data-testid="sidebar-link-${id}"]`,
  sidebarCategory: (slug: string) => `[data-testid="sidebar-cat-${slug}"]`,
  anagrafiche: {
    tab: (tab: string) => `[data-testid="anagrafiche-tab-${tab}"]`,
    searchInput: '[data-testid="anagrafiche-search-input"]',
    openFilters: '[data-testid="anagrafiche-open-filters"]',
    applyFilters: '[data-testid="anagrafiche-apply-filters"]',
    resetFilters: '[data-testid="anagrafiche-reset-filters"]',
    exportCsv: '[data-testid="anagrafiche-export-csv"]',
    groupBy: '[data-testid="anagrafiche-groupby"]',
    recordSheet: '[data-testid="anagrafiche-record-sheet"]',
    loadError: '[data-testid="anagrafiche-load-error"]',
    pageNext: '[data-testid="anagrafiche-page-next"]',
    pagePrevious: '[data-testid="anagrafiche-page-previous"]',
