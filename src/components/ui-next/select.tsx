...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-[var(--h-md)] w-full items-center justify-between gap-2",
      "rounded-[var(--radius-md)] bg-[var(--surface)] px-3",
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      position={position}
      className={cn(
        "ui-next relative z-50 min-w-[8rem] overflow-hidden",
        "rounded-[var(--radius-md)] bg-[var(--surface)] p-1",
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "py-1.5 pl-2 pr-8 text-[var(--text-sm)] text-[var(--foreground-strong)]",
      "outline-none data-[highlighted]:bg-[var(--neutral-100)]",
      "data-[state=checked]:bg-[var(--accent-soft)] data-[state=checked]:text-[var(--accent-ink)]",
