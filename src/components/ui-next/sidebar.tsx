...
const SIDEBAR_COOKIE_NAME = "ui-next-sidebar:state";
    ...
    return (
      <SidebarContext.Provider value={contextValue}>
        <div
          ...
          data-state={state}
          className={cn(
            "group/sidebar-root flex min-h-svh w-full has-data-[variant=inset]:bg-[var(--background-subtle)]",
            className,
          )}
          style={
            {
...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <aside
      ...
      data-slot="sidebar"
      className={cn(
        "group/sidebar flex h-svh shrink-0 flex-col border-r border-[var(--border-subtle)] bg-[#FFF]",
...
>(({ className, ...props }, ref) => (
  <main
    ...
    className={cn(
      "relative flex min-h-svh flex-1 flex-col bg-[var(--surface)]",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      "mx-3 my-1 h-px bg-[var(--border-subtle)]",
      className,
    )}
    {...props}
  />
...
const sidebarMenuButtonVariants = cva(
  [
    "group/menu-button peer/menu-button flex h-[34px] w-full items-center gap-2.5 rounded-[var(--radius-sm)] px-2.5 text-left",
    "text-[var(--text-sm)] text-[var(--foreground-muted)]",
    ...
    "[&_svg]:size-4 [&_svg]:shrink-0 [&_svg]:text-[var(--foreground-subtle)]",
...
>(({ className, ...props }, ref) => (
  <ul
    ...
    className={cn(
      "ml-6 flex min-w-0 flex-col gap-0.5 border-l border-[var(--border-subtle)] pl-2",
      "group-data-[state=collapsed]/sidebar:hidden",
      className,
    )}
    {...props}
...
>(({ className, isActive, asChild, children, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      data-active={isActive || undefined}
      className={cn(
        "flex h-7 w-full items-center gap-2 rounded-[var(--radius-sm)] px-2 text-left",
        "text-[var(--text-sm)] text-[var(--foreground-muted)]",
        "outline-none transition-colors duration-[var(--duration-fast)]",
        "hover:bg-[var(--neutral-150)] hover:text-[var(--foreground-strong)]",
        "data-[active=true]:font-semibold data-[active=true]:text-[var(--foreground-strong)]",
...
/* Backwards-compat slim primitives (legacy ui-next/sidebar API). */
