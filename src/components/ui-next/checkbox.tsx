...
>(({ className, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ...
    className={cn(
      ...
      "data-[state=checked]:bg-[var(--accent)] data-[state=checked]:shadow-[inset_0_0_0_1px_var(--accent)]",
      "data-[state=indeterminate]:bg-[var(--accent)] data-[state=indeterminate]:shadow-[inset_0_0_0_1px_var(--accent)]",
