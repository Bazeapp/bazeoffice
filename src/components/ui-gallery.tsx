...
import { HoverCard, HoverCardContent, HoverCardHeader, HoverCardTrigger } from "@/components/ui/hover-card";
...
import { Sidebar, SidebarItem, SidebarLabel, SidebarSection } from "@/components/ui/sidebar";
import { Skeleton } from "@/components/ui/skeleton";
import { Toaster } from "@/components/ui/sonner";
import { Switch } from "@/components/ui/switch";
import { Table, TableBody, TableCell, TableHead, TableHeader, TableNumeric, TableRow } from "@/components/ui/table";
...
function Section({
  ...
  return (
    <section
      id={id}
      className="scroll-mt-24 rounded-lg bg-surface p-6 shadow-[0_0_0_1px_var(--border)]"
    >
      <header className="mb-5 flex items-center justify-between">
        <h2 className="text-xl font-semibold tracking-(--tracking-snug) text-foreground-strong">
          {title}
        </h2>
        <a
          href={`#${id}`}
...
function StateRow({
  ...
  return (
    <div className="grid grid-cols-1 gap-3 sm:grid-cols-[160px_1fr] sm:items-center">
      <span className="text-2xs font-medium uppercase tracking-(--tracking-wide) text-foreground-faint">
        {label}
      </span>
...
export function UiGallery() {
  return (
    <div className="ui h-svh overflow-y-auto">
      <TooltipProvider delayDuration={200}>
        <div className="mx-auto flex max-w-300 gap-6 px-6 py-10">
          <NavSidebar />
...
function PageHeader() {
  return (
    <div className="rounded-lg bg-linear-to-br from-accent-soft to-surface p-8 shadow-[0_0_0_1px_var(--border)]">
      <div className="text-2xs font-medium uppercase tracking-(--tracking-wider) text-accent-ink">
        ui · Phase 1 preview
      </div>
      <h1 className="mt-2 text-3xl font-semibold tracking-(--tracking-tight) text-foreground-strong">
        Baze Design System refresh
      </h1>
      <p className="mt-2 max-w-160 text-sm text-foreground-muted">
        ...
        <code className="rounded-sm bg-surface-muted px-1.5 py-0.5 font-(--font-mono) text-xs">
          /ui
        </code>{" "}
...
function NavSidebar() {
  return (
    <aside className="sticky top-10 hidden h-[calc(100vh-80px)] w-50 shrink-0 overflow-y-auto rounded-lg bg-surface p-3 shadow-[0_0_0_1px_var(--border)] lg:block">
      <div className="px-2 pb-2 text-2xs font-semibold uppercase tracking-(--tracking-wider) text-foreground-faint">
        Primitives
      </div>
      <nav className="flex flex-col gap-0.5">
        {SECTIONS.map((s) => (
          <a
            key={s.id}
            href={`#${s.id}`}
            className="rounded-sm px-2 py-1 text-xs text-foreground-muted hover:bg-neutral-100 hover:text-foreground-strong"
          >
            {s.title}
          </a>
        ))}
  ...
  return (
    <Section id="input" title="Input">
      ...
      <StateRow label="Empty">
        <Input placeholder="Cerca lavoratori..." className="max-w-70" />
      </StateRow>
      <StateRow label="Disabled">
        <Input
          disabled
          ...
          >
            ...
            >
              ...
              <ComboboxFooter>
                ...
                <button
                  type="button"
                  className="inline-flex h-8 items-center justify-center rounded-md bg-accent px-3 text-sm font-medium text-foreground-on-accent shadow-(--shadow-sm) transition-colors hover:bg-accent-hover"
                >
...
function DatePickerSection() {
  ...
  return (
    <Section id="date-picker" title="Date Picker">
      ...
      <StateRow label="Disabled">
        <DatePicker disabled className="max-w-50" />
      </StateRow>
      <StateRow label="Invalid">
        <DatePicker invalid className="max-w-50" />
      </StateRow>
    </Section>
  );
}
  ...
  return (
    <Section id="input-group" title="Input Group">
      ...
      <StateRow label="Joined + Addon">
        <InputGroup variant="joined" className="max-w-70">
        ...
        <Popover>
          ...
          <PopoverContent>
            <div className="space-y-2">
              <div className="text-sm font-medium">Filtri rapidi</div>
        ...
        <HoverCard>
          ...
          <HoverCardContent>
            <HoverCardHeader>
              ...
              <div>
                <div className="text-sm font-medium">Aria Bocelli</div>
                <div className="text-xs text-foreground-muted">
                  Senior · 5–10 anni
                </div>
              </div>
            ...
            <SheetContent size={size}>
              ...
              <SheetBody>
                <div className="text-sm text-foreground-muted">
                  ...
                  <code className="rounded-sm bg-surface-muted px-1 font-(--font-mono) text-xs">
                    size="{size}"
                  </code>{" "}
                  sullo SheetContent.
                </div>
  ...
  return (
    <Section id="tabs" title="Tabs">
      <StateRow label="Boxed (default)">
        <Tabs defaultValue="anagrafica" className="w-full max-w-130">
      ...
      <StateRow label="Underline">
        <Tabs defaultValue="tutte" className="w-full max-w-120">
          ...
          <TabsContent value="tutte">
            <div className="pt-3 text-sm text-foreground-muted">
              Contenuto Tutte
            </div>
          </TabsContent>
        </Tabs>
      ...
      <StateRow label="Pills">
        <Tabs defaultValue="active" className="w-full max-w-120">
      ...
      <StateRow label="Segmented">
        <Tabs defaultValue="month" className="w-full max-w-70">
          ...
          <AccordionItem value="orari">
            ...
            <AccordionContent>
              <div className="grid grid-cols-2 gap-x-4 gap-y-3">
                <div>
                  <div className="text-[10px] font-medium uppercase tracking-[0.06em] text-foreground-faint">
                    Orario di lavoro
                  </div>
                ...
                <div>
                  ...
                  <div className="mt-1 text-sm text-foreground-strong tabular-nums">
                    8
                  </div>
                </div>
...
function CollapsibleSection() {
  return (
    <Section id="collapsible" title="Collapsible">
      <StateRow label="Default">
        <Collapsible className="w-full max-w-105">
...
function TableSection() {
  return (
    <Section id="table" title="Table">
      <StateRow label="Default">
        <div className="w-full overflow-hidden rounded-md shadow-[0_0_0_1px_var(--border)]">
          <Table>
            <TableHeader>
              <TableRow>
...
function CarouselSection() {
  return (
    <Section id="carousel" title="Carousel">
      <StateRow label="Default">
        <div className="w-full max-w-120 px-12">
          <Carousel>
            <CarouselContent>
              {Array.from({ length: 5 }).map((_, i) => (
                <CarouselItem key={i}>
                  <div className="flex h-32 items-center justify-center rounded-lg bg-accent-soft text-2xl font-semibold text-accent-ink">
                    Slide {i + 1}
                  </div>
                </CarouselItem>
              ))}
...
function SidebarSection2() {
  return (
    <Section id="sidebar" title="Sidebar">
      <StateRow label="Default">
        <div className="overflow-hidden rounded-md shadow-[0_0_0_1px_var(--border)]">
