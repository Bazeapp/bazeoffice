...
>(({ className, ...props }, ref) => (
  <div className="w-full overflow-x-auto">
    <table
      ref={ref}
      className={cn(
        "w-full caption-bottom text-sm text-foreground-strong",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <tr
    ...
    className={cn(
      ...
      "hover:bg-neutral-50 data-[state=selected]:bg-accent-soft",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ...
    className={cn(
      ...
      "text-[10px] uppercase tracking-[0.08em] text-foreground-faint",
