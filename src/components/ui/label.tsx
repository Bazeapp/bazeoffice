...
const labelVariants = cva("inline-flex items-center gap-1.5 text-foreground", {
  variants: {
    variant: {
      ...
      eyebrow:
        "text-[10px] font-semibold uppercase tracking-[0.08em] text-foreground-faint",
      meta: "text-2xs font-semibold uppercase tracking-[0.06em] text-foreground-subtle",
    },
  },
...
>(({ className, variant, required, optional, children, ...props }, ref) => (
  ...
  >
    ...
    {optional ? (
      <span className="font-normal text-foreground-faint">opzionale</span>
    ) : null}
  </LabelPrimitive.Root>
));
