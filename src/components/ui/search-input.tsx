 ...
 *
 * Wraps the default ui Input and overlays a leading magnifier icon.
      ...
      <div className="relative w-full">
        ...
        {showClear ? (
          <button
            ...
            className={cn(
              "absolute right-2 top-1/2 inline-flex size-6 -translate-y-1/2 items-center justify-center rounded-sm",
