...
import {
  ...
  InputGroupButton,
  InputGroupInput,
} from "@/components/ui/input-group-control";
    ...
    <ComboboxPrimitive.Portal>
      ...
      >
        <ComboboxPrimitive.Popup
          ...
          data-chips={!anchor!}
          className={cn(
            "ui group/combobox-content pointer-events-auto",
            "flex flex-col overflow-hidden",
            "rounded-md bg-surface text-foreground-strong",
...
function ComboboxSearch({
  ...
  return (
    <div
      ...
      className="flex items-center gap-2 border-b border-border-subtle px-3 py-2.5"
    >
...
function ComboboxItemCount({
  ...
  return (
    <span
      ...
      className={cn(
        "shrink-0 text-xs tabular-nums text-foreground-faint",
        className,
      )}
      {...props}
    />
...
function ComboboxEmpty({
  ...
  return (
    <ComboboxPrimitive.Empty
      ...
      className={cn(
        "hidden w-full justify-center py-3 text-center text-sm",
...
function ComboboxFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "flex items-center justify-between gap-2 border-t border-border-subtle",
      ...
      {showRemove && (
        <ComboboxPrimitive.ChipRemove
          ...
          className={cn(
            ...
            "text-accent-ink opacity-70 transition-opacity",
            "hover:bg-accent-muted hover:opacity-100",
            "data-pressed:bg-accent-muted",
          )}
        >
...
function ComboboxChipsTrigger({
  ...
  return (
    <div className="ml-auto flex shrink-0 items-center gap-1.5">
      {count != null && count > 0 ? (
        <span className="text-xs font-medium tabular-nums text-foreground-faint">
          +{count}
        </span>
      ) : null}
      <ComboboxPrimitive.Trigger
