...
export const Input = React.forwardRef<HTMLInputElement, InputProps>(
  ({ className, invalid, ...props }, ref) => (
    <input
      ...
      className={cn(
        "h-(--h-md) w-full rounded-md bg-surface",
        "px-3 text-sm text-foreground-strong",
        ...
        "disabled:bg-neutral-100 disabled:text-foreground-faint disabled:cursor-not-allowed",
