...
function makePreviousRapporto(
  ...
  return {
    ...
    numero_rapporto_attivato_con_baze: null,
    ...
    request_lavoratore_referenza: null,
    request_trustpilot_review: null,
    ricevuta_inps_allegati: null,
    richiesta_attivazione_id: null,
    richiedere_trustpilot_temp: null,
    stato_assunzione: null,
    stato_rapporto: "Attivo",
    stato_riattivazione: null,
    stato_servizio: null,
    temp_check_errore_email: null,
    ticket_id: null,
    tipo_contratto: null,
