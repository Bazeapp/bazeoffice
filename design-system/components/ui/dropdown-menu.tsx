...
>(({ className, contextLabel, children, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[14rem] overflow-hidden rounded-[var(--radius-md)] bg-[var(--surface)] p-1.5",
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-[12rem] overflow-hidden rounded-[var(--radius-md)] bg-[var(--surface)] p-1.5",
      "shadow-[0_0_0_1px_var(--border),var(--shadow-lg)]",
      className
    )}
    {...props}
