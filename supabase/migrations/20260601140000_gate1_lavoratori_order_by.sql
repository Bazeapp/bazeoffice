-- FASE 4 BIS — gate1_lavoratori: ordinamento whitelisted via p_order_by/p_order_dir.
-- L'ordine whitelisted è PREPOSTO al default (priorità followup) già esistente.
DROP FUNCTION IF EXISTS public.gate1_lavoratori(integer, integer, text, jsonb);
