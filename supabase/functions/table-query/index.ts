...
const ALLOWED_FIELDS: Record<SupportedTable, string[]> = {
  ...
  selezioni_lavoratori: [
    ...
    "disponibilita_colloquio_lavoratore_slot2_fine",
    "disponibilita_colloquio_lavoratore_slot2_inizio",
    "disponibilita_colloquio_lavoratore_slot3_fine",
    "disponibilita_colloquio_lavoratore_slot3_inizio",
